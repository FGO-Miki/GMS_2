  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <li class="nav-item">
          <a class="nav-link {{ setActive('subjects') }}" href="/subjects">Subject <span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ setActive('subject_strands') }}" href="/subject_strands">Subject Strands</a>
        </li>
        <li class="nav-item">
